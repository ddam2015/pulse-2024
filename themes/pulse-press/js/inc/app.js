...
if (pulse_reveal_closer_today_button.length > 0) {
  pulse_reveal_closer_today_button.on('click', function() {
    localStorage.setItem("pulse_close_today", 'true');
    localStorage.setItem("pulse_close_today_date", new Date() );
  });
}
